...
function AddTex(tex, atlas, inv)
  ...
  if not inv then
    table.insert(Assets, Asset("PKGREF", "images/"..tex..".tex"))
    table.insert(Assets, Asset("DYNAMIC_ATLAS", "images/"..atlas..".xml"))
  else
    table.insert(Assets, Asset("PKGREF", "images/inventoryimages/"..tex..".tex"))
    table.insert(Assets, Asset("DYNAMIC_ATLAS", "images/inventoryimages/"..atlas..".xml"))
  end
